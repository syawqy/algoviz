...
export const PATTERNS: PatternSeed[] = [
  {
    slug: 'two-pointer',
    name: 'Two Pointer',
    blurb: 'Dua jari bergerak dari ujung atau searah. Cocok untuk: array terurut, mencari pasangan. Tiap langkah membuang kandidat.',
  ...
  },
  {
    slug: 'sliding-window',
    name: 'Sliding Window',
    blurb: 'Jendela melebar-nyempit menjaga subset valid. Cocok untuk: substring/subarray, batas panjang tetap/variabel.',
  ...
  },
  {
    slug: 'hash-map',
    name: 'Hash Map',
    blurb: 'Simpan yang sudah dilihat di buku catatan. Cocok untuk: cek duplikat, cari pasangan. Sekali lihat, langsung ketemu.',
  ...
  },
  {
    slug: 'binary-search',
    name: 'Binary Search',
    blurb: 'Buang setengah ruang pencarian tiap langkah. Cocok untuk: array terurut, cari satu nilai. Dari 1000 angka, cukup 10 langkah.',
  ...
  },
  {
    ...
    blurb: 'Hitung dari kecil ke besar, simpan jawaban tiap langkah. Cocok untuk: ada pilihan berulang, optimal substructure.',
  ...
  },
  {
    slug: 'bfs-dfs',
    name: 'BFS & DFS',
    blurb: 'Telusuri lapis demi lapis (BFS) atau sedalam mungkin (DFS). Cocok untuk: grid/graf, jalur terpendek, connected components.',
  ...
  },
  {
    slug: 'stack',
    name: 'Stack',
    blurb: 'Tumpukan menunggu pasangan. Cocok untuk: kurung seimbang, next greater element, evaluasi ekspresi.',
  ...
  },
  {
    ...
    blurb: 'Ambil keputusan terbaik untuk langkah sekarang. Cocok untuk: interval, scheduling, greedy selalu optimal.',
